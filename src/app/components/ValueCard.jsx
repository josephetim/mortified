...
export function ValueCard({ icon, title, description }) {
  return (
    <div className="flex flex-col items-start pt-[32px] pr-[65px] pb-[32px] pl-6 rounded-lg border border-solid bg-neutral-900 border-neutral-800 max-w-[380px] max-md:px-5 max-md:max-w-full">
